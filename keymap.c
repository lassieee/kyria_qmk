 ...
 */
    [_QWERTY] = LAYOUT(
     ...
     KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B,  KC_LBRC,  _______,                      KC_RGUI, KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_MINS,
                    ADJUST, KC_LALT, KC_LSFT, KC_SPACE, TD(TD_LGUI_LCTL),            SYM, MT(MOD_LCTL,KC_ENT), KC_RSFT, KC_RALT, FKEYS
    ),
